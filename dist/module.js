...
function (_super) {
  ...
  tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SimpleCtrl, _super);
  /** @ngInject */
  ...
  SimpleCtrl.prototype._onDataReceived = function (data) {
    ...
    this.panel['text'] = this.resultA - this.resultB;
  };
